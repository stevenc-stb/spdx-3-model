...
A condition, objective or capability required by a agent to solve a problem.

## Description

The statement property captures the natural language articulation of a Need during the Needs Analysis phase. It represents the primary input for the Requirements Engineering process, preserving the agent's original intent before transformation into verifiable system requirements.
