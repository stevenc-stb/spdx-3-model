...
RoleRelationship represents a relationship between two elements (from, to) The givenRole property specifies the Role being assigned from another element to another element within a build, system, distribution, or lifecycle context.
